...
const TabIcon = ({ name, color, size = 20 }) => {
  ...
  if (name === 'quiz')
  return <svg viewBox="0 0 24 24" {...s}><circle cx="12" cy="12" r="8" /><circle cx="12" cy="17" r=".6" fill={color} stroke="none" /><path d="M12 13v-1.5a2 2 0 1 0-2-2" /></svg>;
  if (name === 'profile')
...
Object.assign(window, {
  ...
  EditorialProfile, EditorialCreate, EditorialQuiz,
  TabBar, ED
});